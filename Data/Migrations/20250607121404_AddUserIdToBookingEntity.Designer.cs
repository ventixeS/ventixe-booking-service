...
namespace BookingService.Data.Migrations
{
    ...
    [Migration("20250607121404_AddUserIdToBookingEntity")]
    partial class AddUserIdToBookingEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingAddressEntity", b =>
                {
            ...
            modelBuilder.Entity("BookingOwnerEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BookingEntity", b =>
                {
                    b.HasOne("BookingOwnerEntity", "BookingOwner")
                        .WithMany()
            ...
            modelBuilder.Entity("BookingOwnerEntity", b =>
                {
                    b.HasOne("BookingAddressEntity", "Address")
                        .WithMany()
